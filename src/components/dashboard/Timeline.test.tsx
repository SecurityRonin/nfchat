...
describe('Timeline', () => {
  ...
  it('shows loading state when loading prop is true', () => {
    render(<Timeline data={[]} loading={true} />)
    expect(screen.getByTestId('timeline-loading')).toBeInTheDocument()
  })

  it('shows empty state when data is empty', () => {
    render(<Timeline data={[]} loading={false} />)
  ...
  it('renders with showLegend prop without crashing', () => {
    ...
    render(<Timeline data={mockData} showLegend={true} />)
    expect(screen.getByTestId('timeline-chart')).toBeInTheDocument()
  })
  ...
  it('accepts onBrushChange callback for time selection', () => {
    ...
    render(<Timeline data={mockData} onBrushChange={handleBrush} />)
