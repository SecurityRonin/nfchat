...
describe('FlowPreview', () => {
  it('renders expand button', () => {
    render(<FlowPreview flows={sampleFlows} loading={false} onExpand={vi.fn()} expanded={false} />)
  ...
  it('shows table when expanded', () => {
    render(<FlowPreview flows={sampleFlows} loading={false} onExpand={vi.fn()} expanded={true} />)
  ...
  it('calls onExpand when button is clicked', async () => {
    ...
    render(<FlowPreview flows={sampleFlows} loading={false} onExpand={onExpand} expanded={false} />)
  ...
  it('shows loading state', () => {
    render(<FlowPreview flows={[]} loading={true} onExpand={vi.fn()} expanded={true} />)
    expect(screen.getByText(/loading/i)).toBeInTheDocument()
  })

  it('shows empty state when no flows', () => {
    render(<FlowPreview flows={[]} loading={false} onExpand={vi.fn()} expanded={true} />)
